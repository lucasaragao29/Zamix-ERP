      ...
      @csrf
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <select name=""class='form-control' id="id_produto">
                ...
                @foreach ($produto as $prod)
                  <option value="{{ $prod->id }}">{{ $prod->nome_prod_prod }}</option>
                @endforeach
            </select>
          </div>
          </div>
          <div class="form-group col-md-4">
            ...
            <input type="number" class="form-control" id='preco_custo' value="{{$produtos->preco_custo}}" name="preco_compra_prod">
            <label for="">Preço de Venda</label>
            <input type="text" class="form-control" data-mask="R$ 00,00" value='{{$produtos->preco_venda}}'data-mask-selectonfocus="true" name="preco_venda_prod" id="preco_venda" placeholder="R$: XX,XX">
            <label for="">Preço Total</label>
            <input type="text" class="form-control" data-mask="R$ 00,00"  value='{{$produtos->preco_total}}' data-mask-selectonfocus="true" name="preco_total" id="preco_venda" placeholder="R$: XX,XX">
          </div>
